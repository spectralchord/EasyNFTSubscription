...
import {ForwarderAbi} from "./web3/abi/ForwarderAbi";
import {registerUser} from "./web3/functions";
import {ForwarderAddress, PROVIDER_URL, REGISTRATOR_WALLET_SECRET_KEY} from "./web3/config";
