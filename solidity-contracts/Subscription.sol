...
contract NFTSubscription is ERC2771Context, ERC721, ERC721Enumerable, ERC721URIStorage {
    ...
    ) ERC721("AI Generated NFTs", "AI NFT") ERC2771Context(address(_trustedForwarder)) {
        contractOwner = msg.sender;
        relayer = _relayer;
        trustedForwarderAddress = address(_trustedForwarder);
    ...
    modifier _onlyTrustedForwarder() {
        require(msg.sender == trustedForwarderAddress, "Caller is not trusted forwarder");
        _;
    }
